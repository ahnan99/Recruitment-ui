                ...
                <Row gutter={[16, 32]}>
                    <Col span={24}>
                        <Descriptions title={<a>{jobInfo[0].jobName}</a>}>
                            ...
                            <Descriptions.Item label="福利待遇" labelStyle={{ fontWeight: 'bolder' }}>{jobInfo[0].beneft}</Descriptions.Item>
                            <Descriptions.Item label="说明" labelStyle={{ fontWeight: 'bolder' }}>{jobInfo[0].memo}</Descriptions.Item>
                        </Descriptions>
                    </Col>
                </Row>
